...
from sool.structure.chipset import ChipSet, Chip
from sool.structure.group import Group
from sool.structure.peripheral import Peripheral, PeripheralInstance
